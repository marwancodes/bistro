...
export const DISHES = [
  
  {
    ...
    description: "Small steamed granules of rolled semolina that is often served with a stew spooned on top",
  },
  {
    image: dish2,
  ...
  },
  {
    image: dish4,
    title: "Tagine",
    description: "Preserved with green olives and lemons, especially chicken",
  },
  {
    image: dish5,
  ...
  },
  {
    image: dish7,
    title: "Shakshouka",
    description: "Prepared as poached eggs in a sumptuous tomato sauce filled with traditional spices, olive oil, onions, garlic, and peppers.",
  },
  {
    image: dish8,
    title: "Peking Duck",
...
export const CUSINES = [
  {
    ...
    title: "Moroccan",
    description:
      "Experience the flavors of Morocco with our exquisite Moroccan cuisine, featuring traditional recipes and contemporary dishes.",
  },
  {
    number: "02.",
    image: italian,
...
export const CONTACT = [
  { key: "address", value: "Address: Anfa Street, Casablanca, Morocco" },
  { key: "phone", value: "Phone: 06 614 505 70" },
  { key: "email", value: "Email: marouaneord@gmail.com" },
];

export const SOCIAL_MEDIA_LINKS = [
  {
    href: "https://x.com/MarouaneOUARRA2",
